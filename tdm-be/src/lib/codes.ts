// User input error
export const ERROR_CODE_WRAPPER_BAD_USER_INPUT = '40';
export const ERROR_MESSAGE_WRAPPER_BAD_USER_INPUT = `Le convertisseur a rencontré une erreur inattendue. Code d'erreur ${ERROR_CODE_WRAPPER_BAD_USER_INPUT}`;

// Server Error
export const ERROR_CODE_WRAPPER_UNEXPECTED_ERROR = '50';
...
export const ERROR_CODE_ENRICHMENT_UNREACHABLE_ERROR = '53';
export const ERROR_MESSAGE_ENRICHMENT_UNREACHABLE_ERROR = `L'enrichissement a rencontré une erreur inattendue. Code d'erreur ${ERROR_CODE_ENRICHMENT_UNREACHABLE_ERROR}`;
